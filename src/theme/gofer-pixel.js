...
/**
 * gofer-pixel theme — built by `bunx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { goferPixelTheme } from './gofer-pixel';
 *   import './gofer-pixel.css';
 */
export const goferPixelTheme = {
  name: 'gofer-pixel',
  __built: true,
  tokens: {
    ...
    "--color-background-surface": "light-dark(#eaecf1, #191d25)",
    "--color-background-body": "light-dark(#dfe2e9, #13161c)",
    "--color-background-card": "light-dark(#f4f5f8, #20242e)",
    "--color-background-popover": "light-dark(#ffffff, #282d38)",
    "--color-background-muted": "light-dark(#f1f1f1, #1b1b1b)",
    "--color-accent": "light-dark(#5533e0, #7053ef)",
    "--color-accent-muted": "light-dark(#5533e033, #7053ef3f)",
    ...
    "--color-text-primary": "light-dark(#10131a, #e6e9f0)",
    "--color-text-secondary": "light-dark(#4a5162, #a3a9b8)",
    "--color-text-disabled": "light-dark(#767d8d, #6e7484)",
    "--color-text-accent": "light-dark(#5533e0, #a08cf6)",
    ...
    "--color-icon-accent": "light-dark(#5533e0, #7053ef)",
    ...
    "--color-border": "light-dark(#c2c7d1, #2e3440)",
    "--color-border-emphasized": "light-dark(#6d7484, #7b8294)",
