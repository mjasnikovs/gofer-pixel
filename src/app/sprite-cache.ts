...
import {MODE_AO, MODE_DEPTH_VIEW, MODE_EMISSION, MODE_NORMAL} from '../render/raycast.glsl'
import {volumeDiagonal, type Volume} from '../render/volume'
import type {Pixels} from './PixelCanvas'
...
export const spriteFor = (volume: Volume, camera: Camera, size: number, map: number): Pixels => {
