/*
 * Is the lever the *length* of the example?
 *
...
const REPLIES: Readonly<Record<Arm, string>> = {
    l06: await readFile('out/ladder/dog-06.js', 'utf8'),
    l12: await readFile('out/ladder/dog-12.js', 'utf8'),
    l20: await readFile('out/ladder/dog-20.js', 'utf8'),
    l45: mute.reply
}
